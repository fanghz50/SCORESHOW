...
################################################################################
## Form generated from reading UI file 'YOLOSHOWUI_my.ui'
##
...
"}")
        ...
        self.horizontalLayout_7.addWidget(self.src_webcam)
        ...
        self.src_vsmode = QPushButton(self.cameraBox)
        ...
        self.horizontalLayout_5.addWidget(self.src_vsmode)
        ...
        self.src_camera = QPushButton(self.resultBox)
        ...
        self.horizontalLayout_27.addWidget(self.src_camera)
        ...
        self.src_result = QPushButton(self.tableBox)
        ...
        self.horizontalLayout_28.addWidget(self.src_result)
        ...
        self.src_table = QPushButton(self.vsBox)
        ...
        self.horizontalLayout_26.addWidget(self.src_table)
...
"")
        ...
        self.horizontalLayoutWidget = QWidget(self.rightbox_main)
        self.horizontalLayoutWidget.setObjectName(u"horizontalLayoutWidget")
        self.horizontalLayoutWidget.setGeometry(QRect(130, 10, 1021, 521))
        ...
        self.main_leftbox_1 = QLabel(self.horizontalLayoutWidget)
        self.main_leftbox_1.setObjectName(u"main_leftbox_1")
        self.main_leftbox_1.setMinimumSize(QSize(200, 100))
        self.main_leftbox_1.setStyleSheet(u"background:rgb(0,30,0)")

        self.horizontalLayout_29.addWidget(self.main_leftbox_1)

        self.main_leftbox_2 = QLabel(self.horizontalLayoutWidget)
        self.main_leftbox_2.setObjectName(u"main_leftbox_2")
        self.main_leftbox_2.setMinimumSize(QSize(200, 100))
        self.main_leftbox_2.setStyleSheet(u"background:rgb(0,30,0)")

        self.horizontalLayout_29.addWidget(self.main_leftbox_2)
        ...
        self.main_leftbox_3 = QLabel(self.horizontalLayoutWidget)
        self.main_leftbox_3.setObjectName(u"main_leftbox_3")
        self.main_leftbox_3.setMinimumSize(QSize(200, 100))
        self.main_leftbox_3.setStyleSheet(u"background:rgb(0,30,0)")

        self.horizontalLayout_30.addWidget(self.main_leftbox_3)

        self.main_leftbox_4 = QLabel(self.horizontalLayoutWidget)
        self.main_leftbox_4.setObjectName(u"main_leftbox_4")
        self.main_leftbox_4.setMinimumSize(QSize(200, 100))
        self.main_leftbox_4.setStyleSheet(u"background:rgb(0,30,0)")

        self.horizontalLayout_30.addWidget(self.main_leftbox_4)
        ...
        self.main_rightbox = QLabel(self.horizontalLayoutWidget)
        self.main_rightbox.setObjectName(u"main_rightbox")
        self.main_rightbox.setMinimumSize(QSize(200, 100))
        self.main_rightbox.setStyleSheet(u"background:rgb(0,30,0)")

        self.horizontalLayout_9.addWidget(self.main_rightbox)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.title.setText(QCoreApplication.translate("MainWindow", u"\u81ea\u52a8\u8bc4\u5206\u7cfb\u7edf", None))
        ...
        self.src_menu.setText(QCoreApplication.translate("MainWindow", u"\u83dc\u5355", None))
        self.src_webcam.setText(QCoreApplication.translate("MainWindow", u"\u6253\u5f00\u6444\u50cf\u5934", None))
        self.src_vsmode.setText(QCoreApplication.translate("MainWindow", u"\u89c6\u89d2\u62fc\u63a5", None))
#if QT_CONFIG(shortcut)
        self.src_vsmode.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
        self.src_camera.setText(QCoreApplication.translate("MainWindow", u"\u76ee\u6807\u8ddf\u8e2a", None))
        self.src_result.setText(QCoreApplication.translate("MainWindow", u"\u8ba1\u7b97\u5f97\u5206", None))
        self.src_table.setText(QCoreApplication.translate("MainWindow", u"\u6210\u7ee9\u6c47\u603b", None))
        self.src_setting.setText(QCoreApplication.translate("MainWindow", u"\u7cfb\u7edf\u8bbe\u7f6e", None))
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"\u76f8\u4f3c\u5ea6", None))
        self.Target_num.setText("")
        self.fpsLabel.setText("")
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"\u65f6\u95f4", None))
        self.fps_label.setText("")
        self.modelLabel.setText("")
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"\u6a21\u578b", None))
        self.Model_label.setText("")
        self.main_leftbox_1.setText("")
        self.main_leftbox_2.setText("")
        self.main_leftbox_3.setText("")
        self.main_leftbox_4.setText("")
